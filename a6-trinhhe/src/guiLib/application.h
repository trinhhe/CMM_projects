...
public:
    Application(const char *title, int width, int height, std::string iconPath = CMM_ASSETS_FOLDER"/crl_icon_blue.png", std::string font_path = IMGUI_FONT_FOLDER"/Roboto-Medium.ttf");
